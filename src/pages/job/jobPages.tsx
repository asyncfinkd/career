        ...
        <div className=" flex-1 flex flex-wrap" id="job-83543">
          <article className="w-full md:w-7/12 pl-4 pr-6 p-6">
            <div className="pb-4 border-b-2" role="banner">
              ...
              <a
                href="#apply"
                className="btn-color spec-btn px-8 py-2 font-medium text-white rounded shadow-sm block md:hidden mt-4 text-center button"
              >
                &#x10D2;&#x10D0;&#x10DB;&#x10DD;&#x10D0;&#x10D2;&#x10D6;&#x10D0;&#x10D5;&#x10DC;&#x10D4;&#x10D7;
                &#x10D2;&#x10D0;&#x10DC;&#x10D0;&#x10EA;&#x10EE;&#x10D0;&#x10D3;&#x10D8;
              </a>
            ...
            <div role="article" className="ql-editor py-6 hh-job-description">
              <p className="ql-align-justify">
                <strong>სს "საქართველოს ბანკის"&nbsp;</strong>საკრედიტო
                ადმინისტრირებისა და დოკუმენტირების დეპარტამენტი&nbsp;აცხადებს
                ვაკანსიას&nbsp;
                <strong>
                  საკრედიტო ოპერაციების კონტროლის სამსახურის
              ...
              <ul>
                <li>
                  დაქვემდებარებული ბიზნეს ერთეულის პროცესების ფორმირება და
                  ოპტიმიზაცია, დეპარტამენტის საერთო ბიზნეს ამოცანების
                  შესაბამისად;
                </li>
                <li>
                  დაქვემდებარებული პერსონალის მუდმივ განვითარებაზე ზრუნვა:
                  ქოუჩინგი, ტრენინგების დაგეგმვა, მოტივაცია;
                </li>
                <li>
                  <span style={{ color: "rgb(91, 91, 91)" }}>
                    სამუშაო პროცესში შემაფერხებელი გარემოებების/პრობლემების
                    იდენტიფიცირება და გადაჭრის გზების მოძიება. საჭიროებისას,
                    შესაბამისი ესკალაციის განხორციელება.
                  </span>
                </li>
                <li>დეპარტამენტის დირექტორთან ანგარიშგების წარმოება;</li>
                <li>
                  საკრედიტო პროდუქტების ადმინისტრირების პროცესების მართვა;
                </li>
                <li>
                  საკრედიტო კომიტეტის მიერ დამტკიცებული პირობების
                  აღრიცხვა-კონტროლის პროცესის გამართულად მუშაობის უზრუნველყოფა;
                </li>
                <li>
                  საკრედიტო ფაილის სისრულისა და საკრედიტო კომიტეტის
                  გადაწყვეტილებასთან შესაბამისობის გადამოწმების პროცესის მართვა;
                </li>
                <li>
                  საკრედიტო პროდუქტების პროგრამულ უზრუნველყოფაში რეგისტრაციის
                  პროცესის მართვა;
                </li>
                <li>
                  გუნდში ჯანსაღი კორპორატიული გარემოს შენარჩუნების მონიტორინგი;
                </li>
                <li>
                  თანამშრომლების შრომის დისციპლინისა და სამუშაო დროის
                  რაციონალურად გამოყენების მონიტორინგი;
                </li>
              </ul>
              ...
              <p>
                ...
                უმაღლესი, იურიდიული განათლება ჩაითვლება უპირატესობად&nbsp;&nbsp;
              </p>
              <p>
                <br />
              </p>
              ...
              <p>
                ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;კონფლიქტური
                სიტუაციების მართვის და სწორი გადაწყვეტილების მიღების უნარი;
              </p>
              <p>
                ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ობიექტურობა,
              ...
              <p>
                ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ამოცანის
                ანალიზის, კრიტიკული შეფასების, საკვანძო და პრობლემური საკითხების
                დადგენის და მათი გადაწყვეტის უნარი;
              </p>
              <p>
                <br />
              </p>
            ...
            <div className="">
              ...
              >
                ...
                <input
                  ...
                  value="8148"
                />
                <input id="JobId" name="JobId" type="hidden" value="83543" />
                <input
                  id="RenderedAt"
                  name="RenderedAt"
                  type="hidden"
